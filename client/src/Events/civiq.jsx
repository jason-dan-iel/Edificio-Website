              ...
              <ol className="list-disc px-10">
                ...
                <ol className="my-5 list-decimal">
                  <li className="font-semibold underline">
                    First Round [CIVIL101] (All teams can participate)
                  </li>
                  <ol className="list-disc px-5">
                    <li>
                      Civil 101: To test the fact based civil engineering
                      knowledge and a few conceptual questions
                    </li>
                    <li>
                      The final score of round 1 will serve as the basis for the
                      entry in round 2
                    </li>
                  </ol>
                  <li className="font-semibold underline">
                    Second Round [Crusade the Concepts]
                  </li>
                  <ol className="list-disc px-5">
                    <li>
                      Only the top five teams from round one will be eligible
                      for this round
                    </li>
                    <li>
                      This will also be an objective quiz consisting of multiple
                      correct questions
                    </li>
                    <li>
                      Crusade the Concepts (brainstorming questions covering a
                      range of topics within civil engineering, such as
