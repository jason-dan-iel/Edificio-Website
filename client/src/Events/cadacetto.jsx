            ...
            <ul>
              ...
              <li>
                <p className="mb-3 font-normal text-gray-700 text-lg">
                  The CADecetto event is an online event that will be attended
                  by eligible participants from across the country, including
                  academics and industry professionals. The event aims to test
                  the creativity and drafting skills of participants using CAD
                  platforms. Winners will be announced on the basis of their
                  performance and awarded cash prizes, while all participants
              ...
              <li>
                It will be an individual event for the participants. This
                contest will happen in 2 tiers in the form of league-type
                rounds. Students will be eliminated after each tier.
              </li>
              <ol className="list-decimal px-10 my-2">
                <li className="mt-2 font-semibold underline">
                  Tier 1 Pupil Round
                </li>
                <ol className="list-disc list-inside">
                  ...
                  <li>
                    The problem statement will be released through the google
                    meet.
                  </li>
                </ol>
                <li className="mt-2 font-semibold underline">
                  Tier 2 “The Veteran One” Round
                </li>
                <ol className="list-disc px-5">
                  ...
                  <li>
                    Similar to tier 1 round but the difficulty level of the
                    problem will be higher.
                  </li>
                  <li>
                    The problem statement will be released through the google
                    meet.{" "}
                ...
                <li>
                  Submissions must be made within the stipulated time limit.
                </li>
                <li>
                  All participants will be shown an AutoCAD file and they will
                  have to design a similar figure with the given information
                  about it in AutoCAD/Revit.
                </li>
                <li>Top 3 teams will be declared as the winners.</li>
                <li className="font-bold">
                  Work should be done on your own (plagiarism check will be
                  done).
                </li>
                <li>
                  ...
                  <a
                    ...
                    href="https://www.edificioiitj.org.in/cadecetto"
                    target={"_blank"}
                  >
                    Link
                  </a>{" "}
