            ...
            <ul>
              ...
              <li>
                <p className="mb-3 font-normal text-gray-700 text-lg">
                  The Department of Civil & Infrastructure Engineering welcomes
                  you all to submit technical presentations related to any
                  project/research work you have undertaken. Being a department
                  thriving to achieve interdisciplinary solutions, we encourage
                  students of varied engineering backgrounds to help solve
                  real-world civil engineering-oriented problems through their
              ...
              <ol className="list-disc px-10 mb-3 text-gray-700">
                ...
                <li>
                  Participants shall prepare PPTs with not more than 15 slides
                </li>
                <li>
                  Contents of the slides can be flexible (expected contents are:
                  Brief introduction, motivation and objectives, methods,
                  results, conclusions, and references)
                </li>
                <li className="italic font-black text-black">
                  Work should be original (plagiarism check will be done)
                </li>
                <li>
                  Participants have to register the event on the EDIFICIO
                  website{" "}
                  <a
                    className="inline hover:cursor-pointer text-blue-400 underline italic"
                    href="https://www.edificioiitj.org.in/eureka"
                    target={"_blank"}
                  >
                    Link
                  </a>{" "}
                ...
                <li>
                  Submission will be done through the google form, we will send
                  the mail to all the registered candidates.
                </li>
                <li>Round I (Online Presentation Submission)</li>
                <ol className=" list-inside list-decimal">
                  <li>
                    Participants need to make a presentation with not more than
                    15 slides.
                  </li>
                  <li>
                    Submission Deadline : 12.03.2023 11:59 P.m. (Submission form
                    will be shared to the registered participants)
                  </li>
                </ol>
                ...
                <ol className=" list-inside list-decimal">
                  ...
                  <li>
                    Participants need to present their ppts to the judges.
                  </li>
                  Each participant will get only 8 minutes for their
                  presentation, exceeding the time limit will result in penalty
                  of points.
                </ol>
